            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Faça Login para continuar na Doar Digital.</p>
                                </div>
                                <div class="p-2 mt-4">
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Não possui conta ? <a href="#" class="fw-semibold text-primary text-decoration-underline"> Cadastre-se </a> </p>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> Doar Digital. Desenvolvido por <i class="mdi mdi-heart text-danger"></i> Digital Combo
                            </p>
                        </div>
                    </div>
                </div>
